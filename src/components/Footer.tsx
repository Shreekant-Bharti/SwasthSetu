        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 group">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-teal to-coral bg-clip-text text-transparent">
                SwasthSetu
              </span>
            </div>
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="p-2 rounded-full bg-white/10 hover:bg-teal/30 text-white hover:text-teal transition-all duration-300 hover:scale-110"
              >
                <Facebook className="w-5 h-5" />
              </a>
              <a
                href="#"
                className="p-2 rounded-full bg-white/10 hover:bg-indigo/30 text-white hover:text-indigo transition-all duration-300 hover:scale-110"
              >
                <Twitter className="w-5 h-5" />
              </a>
              <a
                href="#"
                className="p-2 rounded-full bg-white/10 hover:bg-coral/30 text-white hover:text-coral transition-all duration-300 hover:scale-110"
              >
                <Instagram className="w-5 h-5" />
              </a>
              <a
                href="#"
                className="p-2 rounded-full bg-white/10 hover:bg-soft-green/30 text-white hover:text-soft-green transition-all duration-300 hover:scale-110"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#home"
                  className="text-white/70 hover:text-teal transition-all duration-300 hover:translate-x-1 inline-block"
                >
                  Home
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-white/70 hover:text-coral transition-all duration-300 hover:translate-x-1 inline-block"
                >
                  Online Consultation
                </a>
              </li>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-white/70 hover:text-white transition-colors">
                ...
                <span className="text-sm">
                  Rural Health Initiative, New Delhi, India
                </span>
              </li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-white/50 mt-1">
              ...
              <span className="text-teal font-semibold">Beyond Infinity</span>
            </p>
          </div>
          <div className="flex gap-6 text-sm text-white/60">
            ...
            <a
              href="#"
              className="hover:text-indigo transition-colors duration-300"
            >
              Cookie Policy
            </a>
          </div>
